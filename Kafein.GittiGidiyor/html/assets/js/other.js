...
!function(window, document, undefined) {
    ...
    SL.extend(NielsenTool.prototype, {
        ...
        preparePrefix: function(e) {
            return "http://" + encodeURIComponent(e) + ".imrworldwide.com/cgi-bin/gn?"
        },
    ...
    _satellite.init({
        ...
        pageLoadRules: [{
            ...
            trigger: [{
                ...
                command: "writeHTML",
                arguments: [{
                    html: '<script type="text/javascript">\n	var gg = gg || {};\n			eval(AFFILIATE_PRODUCTS.replace(/&/g, ";").replace(/\\[/g, "[\'").replace(/\\]/g, "\']"));\n	var tech = "b,g,n,v,x".split(","), ceptel = "t".split(","), subaltin="ma".split(",");\n	var pGNonT = pGT = pCep = pAlt = pCNonT = pCT = +0;\n	var isGG, cat, sku, al, go_name;\n		for (var i in gg) {\n	var arr = i.split("_"), pr = +gg[i];\n	sku = arr[0], cat = arr[1][0], isGG = arr[2] == "gg", al=arr[1];\nif (tech.indexOf(cat) >= 0) if (isGG) {pGT = pr;  var skutechgg=sku; new Image().src = "http://tr.rdrtr.com/GL7Vm?adv_sub=" + skutechgg + "_t_gg&amount=" + pGT+"&adv_sub3="+al+"&adv_sub5="+TRACKING_TRANSACTION_ID+"";}  else {pCT = pr; var skutechcadde=sku; new Image().src = "http://tr.rdrtr.com/GL82m?adv_sub=" + skutechcadde + "_t_cadde&amount=" + pCT+"&adv_sub3="+al+"&adv_sub5="+TRACKING_TRANSACTION_ID+"";} \nelse if (ceptel.indexOf(cat) >= 0) {pCep = pr; var skucpgg=sku; new Image().src = "http://tr.rdrtr.com/GL7Vy?adv_sub=" + skucpgg + "_c_gg&amount=" + pCep+"&adv_sub3="+al+"&adv_sub5="+TRACKING_TRANSACTION_ID+"";} \nelse if (subaltin.indexOf(al) >= 0) {pAlt = pr; var skualtgg=sku; new Image().src = "http://tr.rdrtr.com/GL7Vs?adv_sub=" + skualtgg + "_g_gg&amount=" + pAlt+"&adv_sub3="+al+"&adv_sub5="+TRACKING_TRANSACTION_ID+"";}\nelse \n if (isGG) {pGNonT = pr; var skuntgg=sku; new Image().src = "http://tr.rdrtr.com/GL7Vg?adv_sub=" + skuntgg + "_nt_gg&amount=" + pGNonT+"&adv_sub3="+al+"&adv_sub5="+TRACKING_TRANSACTION_ID+"";} else {pCNonT = pr; var skuntcadde=sku; new Image().src = "http://tr.rdrtr.com/GL82s?adv_sub=" + skuntcadde + "_nt_cadde&amount=" + pCNonT+"&adv_sub3="+al+"&adv_sub5="+TRACKING_TRANSACTION_ID+"";}\n }\n</script>'
                }]
            }],
            conditions: [function() {
            ...
            trigger: [{
                command: "writeHTML",
                arguments: [{
                    html: "<script type=\"text/javascript\">\ntry {\n    var lumberjackConfig = {\n        url: '/xhr/run-lumberjack-for-main-page-ajax',\n        params: {\n            'module': 'homepage',\n            'contentName': TRACKINGCONTENTNAME,\n            'referer': document.referrer\n        }\n    };\n\n\n    var lumberjackCtrl = new _ggLumberjackController(lumberjackConfig);\n    lumberjackCtrl.send();\n\n} catch (e) {\n    console.info('lj error =' + e)\n}\n</script>"
                }]
            }],
            conditions: [function() {
                return _satellite.textMatch(_satellite.getVar("TRACKINGPAGENAME"), "Home Page")
